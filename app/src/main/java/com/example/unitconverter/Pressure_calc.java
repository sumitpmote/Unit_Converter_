...
public class Pressure_calc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pressure_calc);
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(Pressure_calc.this);
