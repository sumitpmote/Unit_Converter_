...
public class Length_calc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_length_calc);
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(Length_calc.this);
